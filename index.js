...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:TH\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=554791054916:+55 4791054916\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD TH BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] TH? Este é um recurso especial para o TH ❌',
					ownerB: '[❗] TH? Este é um recurso especial para o TH ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de TH. Registre-se para fazer amizade com o bot TH por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Causs|17\n\n──「 TH BOT 」──`,
			...
			const ownerNumber = ["554791054916@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"553193019630@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["553193019630@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["553193019630@s.whatsapp.net"]//ubah nomor lo
			const premium = ["554792091566@s.whatsapp.net","554791054916@s.whatsapp.net"] 
